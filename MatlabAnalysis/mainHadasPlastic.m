function BdaTpaList = mainHadasPlastic(pth, outputPath, Trials2keep, pthTraj, xmlfile, movpath)
...
runAnalysis(fullfile(outputPath, 'Pca2D'), xmlfile, BdaTpaList, 'Pca2D');close all;
runAnalysis(fullfile(outputPath, 'pcaTrajectories'), xmlfile, BdaTpaList, 'pcaTrajectories');close all;

runAnalysis(fullfile(outputPath, 'svmAccuracy'), xmlfile, BdaTpaList, 'svmAccuracy');close all;
