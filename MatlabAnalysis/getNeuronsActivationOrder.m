function [peakVal, peakTime, order_loctions_neurons, neurons_order_index, meanDat, meanbase, stdbase] = getNeuronsActivationOrder(t, currData, toneTime, minPointsForSettingActivity, onsetdiffvalid)
