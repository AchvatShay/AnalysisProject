...
BDA_TAPpath ='D:\Maria\Layer 2-3\Analysis\M27\1_8_18';
 outputpath = 'I:\Maria_revisions Neuron\Hadas_analysis4revision\hand_trajectories_analysis\M27_1_8_18';
 mkdir(outputpath);
 tpalist{1}= mainHadas(BDA_TAPpath, outputpath, [], trajectoriesPath, 'XmlByBoth20.xml');
end
try
% M27 1 18 18
trajectoriesPath='D:\Maria\Layer 2-3\Videos\M27\1_18_18';
BDA_TAPpath ='D:\Maria\Layer 2-3\Analysis\M27\1_18_18';
 outputpath = 'I:\Maria_revisions Neuron\Hadas_analysis4revision\hand_trajectories_analysis\M27_1_18_1';
 mkdir(outputpath);
 tpalist{1}= mainHadas(BDA_TAPpath, outputpath, [], trajectoriesPath, 'XmlByBoth20.xml');
end
try
...
BDA_TAPpath ='D:\Maria\Layer 2-3\Analysis\M27\1_10_18';
 outputpath = 'I:\Maria_revisions Neuron\Hadas_analysis4revision\hand_trajectories_analysis\M27_1_10_1';
 mkdir(outputpath);
 tpalist{1}= mainHadas(BDA_TAPpath, outputpath, [], trajectoriesPath, 'XmlByBoth20.xml');
end
try
...
BDA_TAPpath ='D:\Maria\Layer 2-3\Analysis\M27\1_3_18';
 outputpath = 'I:\Maria_revisions Neuron\Hadas_analysis4revision\hand_trajectories_analysis\M27_1_3_17';
 mkdir(outputpath);
 tpalist{1}= mainHadas(BDA_TAPpath, outputpath, [], trajectoriesPath, 'XmlByBoth.xml');
end
return;
% M27 12 31 17
