...
switch lower(generalProperty.PelletPertubation)
    ...
    case 'taste'
        ...
        clrs(end+1, :) = [1 0 0];
        % unmarked trials have label 0 and we won't plot them
        visualizeTrajectories(generalProperty.visualization_bestpcatrajectories2plot, ...
            ...
            eventsStr, prevCurrLUT, labelsLUT, [], [], labels, prevcurlabs, outputPath, ...
            generalProperty, pcaTrajres.projeff, X, 'PCA', labelsTasteWithFails, labelsLUTTaste, clrs, eventsStrTaste);
%  visualizeTrajectories(generalProperty.visualization_bestpcatrajectories2plot, ...
%             generalProperty.prevcurrlabels2clusterClrs, generalProperty.labels2clusterClrs, ...
